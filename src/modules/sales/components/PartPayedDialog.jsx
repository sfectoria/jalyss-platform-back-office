...
function PartPayedDialog({setPartAmount,openPartPayed=false,setOpenPartPayed,setRefresh,refresh,rowInfo={},setEditingRowId}) {
  ...
  return (
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>
            Please enter the payed amount , the Total Amount : {rowInfo?.totalAmount}
          </DialogContentText>
          {rowInfo?.payedAmount!==rowInfo?.totalAmount&&<DialogContentText>
